      ...
      {testimonials.map((t, index) => (
        ...
        >
          <div className='flex flex-col items-end gap-2 md:gap-3'>
            <svg style={{ fill: `var(--color-${colors[index % colors.length]})` }} width="24" height="21" viewBox="0 0 24 21" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center gap-2 justify-start">
            <div className={`w-10 h-10 rounded-full text-white flex items-center justify-center font-medium text-2xl`} style={{ backgroundColor: `var(--color-${colors[index % colors.length]})` }}>
              {t.name[0]}
            </div>
